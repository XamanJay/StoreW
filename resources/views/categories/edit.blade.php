        ...
        <div class="row">
            <div class="col-md-4">
                    <label for="">Nombre </label>
                        <input placeholder="" autofocus id="Nombre" name="Nombre" class="form-control" type="text" value="{{ $categories->Nombre }}" required  >
            </div>
            <div class="col-md-4">
                        <label for="">Código </label>
                        <input id="Codigo" name="Codigo" class="form-control" type="text" value="{{ $categories->Codigo }}"   >
            </div>
            <div class="col-md-4">
                <label for="">CPadre </label>
                <input id="CPadre" name="CPadre" class="form-control" type="text" value="{{ $categories->CPadre }}"   >
            </div>
        </div>
