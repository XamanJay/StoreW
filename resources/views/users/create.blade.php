...
<!--+----------+----------------+-----------------+------------------------------------+-------------------------------+-------------------------+--------------+------------+ -->		
<form action="/userws" method="POST" >
    @csrf
    ...
    <div class="row" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
        ...
        <div class="row">
            <div class="col-md-6">
                    <label for="">Nombre.  </label>
                        <input placeholder="" autofocus id="firstname" name="firstname" class="form-control" type="text" value="" required  >
                </div>
                <div class="col-md-6">
        ...
        <div class="row">  
                ...
                <div class="form-group  col-sm-3">
                    ...
                    <select id="type" name="type" size="2" class="form-select form-select">    
